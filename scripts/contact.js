...
let copyTexts = ["galeria.ro-purchase@gmail.com", "+40 727 000 000", "galeria.ro-helpline@gmail.com", "+40 727 999 999"];
...
for (let i = 0; i < buttons.length; i++) {
    buttons[i].addEventListener("mousedown", async (e) => {
        ...
        if (navigator.clipboard && navigator.clipboard.writeText) {
            ...
            console.error('writeText method not supported');
            alert('Clipboard writeText method not supported');
        }
    });
}